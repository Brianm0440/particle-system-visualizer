# 🚀 Quick Start: Deploy to Google Workspace

## Option 1: Google Sites (5 minutes - Recommended)
...
2. **Create New Site**
   ...
   - Give it a name like "3D Particle System"

3. **Add Your App**
   - Click the "+" button to add content
   - Select "Embed" from the menu
   - Click "Embed code" tab
   - Copy the entire content of `index.html` (below)
   - Paste it into the embed code box
   - Click "Next" then "Insert"

4. **Publish**
   - Click "Publish" in the top right
   - Choose your domain (your-workspace.com)
   - Click "Publish"

**Done!** Your app will be live at: `https://sites.google.com/view/your-site-name`

---

## Option 2: Google Drive (2 minutes)

### Step-by-Step:

1. **Upload Files**
   - Go to [drive.google.com](https://drive.google.com)
   - Upload `index.html`, `script.js`, `styles.css`
...
3. **Access**
   - Use the shared link to access your app

---

## Option 3: Google Cloud (10 minutes)
...
## File Contents for Google Sites

Copy this entire content into Google Sites embed code:
...
<body>
    ...
    <script>
        ...
        class Particle {
            constructor(x, y, z, size, colorScheme) {
                this.x = x;
                this.y = y;
                this.z = z;
                this.size = size;
            ...
            draw(ctx) {
                const alpha = 1.0;
                const size = Math.max(5, this.size);
...
- **Google Sites issues**: Check if JavaScript is enabled in your browser
- **Google Drive issues**: Make sure files are set to "Anyone can view"
- **Google Cloud issues**: Run `gcloud auth login` first

**Recommended:** Start with Option 1 (Google Sites) - it's the easiest and most integrated with your Google Workspace!
