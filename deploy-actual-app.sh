...
# 🚀 Deploy Your Actual 3D Particle System
...
echo -e "${BLUE}🚀 Deploying your actual 3D Particle System...${NC}"
...
echo -e "${BLUE}🏗️ Creating server with your 3D Particle System...${NC}"
...
echo "   2. Run: ./deploy-actual-app.sh"
...
# Clean up
rm -f server-app.js package.json Dockerfile
